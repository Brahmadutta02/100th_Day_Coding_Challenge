                    ...
                    const r = (t, e) => {
                        ...
                        a = (t, e) => {
                            ...
                            const d = u(t.title, 100),
                                _ = (t => {
                                    var e;
                                    const n = t.video.filter((t => "mp4" === t.format)),
                                        r = null == (e = t.storyboard) ? void 0 : e.find((t => "mp4" === t.format)),
                                        i = n.map((t => ({
                                            width: t.width,
                                            height: t.height,
                                            quality: t.quality,
...
//# sourceMappingURL=https://static.parastorage.com/services/editor-elements-library/dist/corvid/rb_wixui.corvid[Column].287bb506.bundle.min.js.map