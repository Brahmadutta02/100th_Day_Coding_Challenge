...
const _elementPropsSDKFactory = api => ({
...
export const elementPropsSDKFactory = composeSDKFactories(basePropsSDKFactory, viewportPropsSDKFactory, _elementPropsSDKFactory, effectsTriggersSDKFactory);
export const createElementPropsSDKFactory = ({
    useHiddenCollapsed = true,
    hasPortal = false,
} = {}) => {
    return composeSDKFactories(basePropsSDKFactory, _elementPropsSDKFactory, effectsTriggersSDKFactory, deletePropsSDKFactory, useHiddenCollapsed ?
