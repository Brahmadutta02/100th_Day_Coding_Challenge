var e, t, n, r, i, a = function() {
    ...
    m = function(e, t) {
        var n = a(),
            r = "navigate";
        return f() >= 0 ? r = "back-forward-cache" : n && (r = document.prerendering || l() > 0 ? "prerender" : document.wasDiscarded ? "restore" : n.type.replace(/_/g, "-")), {
            name: e,
            value: void 0 === t ? -1 : t,
            rating: "good",
            delta: 0,
            ...
            var n, r = [1800, 3e3],
                ...
                o = v("paint", (function(e) {
                    e.forEach((function(e) {
                        "first-contentful-paint" === e.name && (o.disconnect(), e.startTime < i.firstHiddenTime && (a.value = Math.max(e.startTime - l(), 0), a.entries.push(e), n(!0)))
                    }))
                }));
            o && (n = h(e, a, r, t.reportAllChanges), d((function(i) {
                a = m("FCP"), n = h(e, a, r, t.reportAllChanges), g((function() {
                    ...
                    s = function(e) {
                        e.forEach((function(e) {
                            if (!e.hadRecentInput) {
                                var t = u[0],
                                    r = u[u.length - 1];
                                o && e.startTime - r.startTime < 1e3 && e.startTime - t.startTime < 5e3 ? (o += e.value, u.push(e)) : (o = e.value, u = [e]), o > i.value && (i.value = o, i.entries = u, n())
                            }
                        }))
                    },
                    f = v("layout-shift", s);
                f && (n = h(c, i, r, t.reportAllChanges), w((function(e) {
                    a = e.value, i.value < 0 && (i.value = 0, n())
                })), p((function() {
                    s(f.takeRecords()), n(!0)
                })), d((function() {
                    o = 0, a = -1, i = m("CLS", 0), n = h(c, i, r, t.reportAllChanges), g((function() {
                        return n()
                    }))
                })))
            }))
    ...
    F = new Date,
    I = function(r, i) {
        e || (e = i, t = r, n = new Date, P(removeEventListener), B())
    },
    B = function() {
        if (t >= 0 && t < n - F) {
            var i = {
    ...
    k = function(n, i) {
        i = i || {}, y((function() {
            var a, o = [100, 300],
                ...
                l = v("first-input", f);
            a = h(n, c, o, i.reportAllChanges), l && p((function() {
                f(l.takeRecords()), l.disconnect()
            }), !0), l && d((function() {
                var u;
                c = m("FID"), a = h(n, c, o, i.reportAllChanges), r = [], t = -1, e = null, P(addEventListener), u = s, r.push(u), B()
            }))
        }))
    },
    R = function(e, t) {
    ...
    O = function(e) {
        e.forEach((function(e) {
            e.interactionId && (q = Math.min(q, e.interactionId), H = Math.max(H, e.interactionId), N = H ? (H - q) / 7 + 1 : 0)
        }))
    },
    j = function() {
    ...
    U = function() {
        "interactionCount" in performance || i || (i = v("event", O, {
            type: "event",
            buffered: !0,
            durationThreshold: 0
        }))
    ...
    K = function(e, t) {
        t = t || {}, y((function() {
            ...
            var r, i = m("INP"),
                a = function(e) {
                    e.forEach((function(e) {
                        (e.interactionId && J(e), "first-input" === e.entryType) && (!z.some((function(t) {
                            return t.entries.some((function(t) {
                                return e.duration === t.duration && e.startTime === t.startTime
                            }))
                        })) && J(e))
                    }));
                    var t, n = (t = Math.min(z.length - 1, Math.floor(_() / 50)), z[t]);
            ...
            r = h(e, i, n, t.reportAllChanges), o && (o.observe({
                ...
                a(o.takeRecords()), i.value < 0 && _() > 0 && (i.value = 0, i.entries = []), r(!0)
            })), d((function() {
                z = [], V = j(), i = m("INP"), r = h(e, i, n, t.reportAllChanges)
            })))
        }))
    },
    Q = function(e, t) {
        ...
        ! function(e, t) {
            t = t || {}, y((function() {
                ...
                if (u) {
                    ...
                    var c = function() {
                        W[a.id] || (o(u.takeRecords()), u.disconnect(), W[a.id] = !0, n(!0))
                    };
                    ["keydown", "click"].forEach((function(e) {
                        ...
                        a = m("LCP"), n = h(e, a, r, t.reportAllChanges), g((function() {
                            a.value = performance.now() - i.timeStamp, W[a.id] = !0, n(!0)
                        }))
                    }))
                }
            }))
    ...
    Z = function(e, t) {
        ...
        Y((function() {
            ...
            if (o) {
                ...
                r.value = Math.max(u - l(), 0), r.entries = [o], i(!0), d((function() {
...
export {
    M as onCLS, x as onFCP, R as onFID, Q as onINP, X as onLCP, $ as onTTFB
};