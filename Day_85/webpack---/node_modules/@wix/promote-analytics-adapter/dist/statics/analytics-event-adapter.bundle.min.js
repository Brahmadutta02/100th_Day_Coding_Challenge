        ...
        return function() {
            ...
            var b = ["type"],
                ...
                O = {
                    ...
                    InitiateCheckout: function(e) {
                        return [
                            ["track", "InitiateCheckout", a()({}, x(T(e)), e.contents && {
                    ...
                    AddPaymentInfo: function(e) {
                        return [
                            ["track", "AddPaymentInfo", a()({}, x(T(e)), e.contents && {
                                content_ids: e.contents.map((function(e) {
                                    return e.id
                                })),
                                content_type: "product"
                    ...
                    Purchase: function(e, n) {
                        if (n.isFBServerEventsEnabled) {
                            var t = a()({}, x(T(e)), e.contents && {
                                ...
                                r = function(e) {
                                    return e.origin === I ? e.orderId : e._internalEventId
                                }(e),
                        ...
                        return [
                            ["track", "Purchase", a()({}, x(T(e)), e.contents && {
                                content_ids: e.contents.map((function(e) {
                                    return e.id
                                })),
                                content_type: "product"
                ...
                D = {
                    ...
                    AddProductImpression: function(e) {
                        var n = (e.contents || []).map((function(e) {
                            return ["ec:addImpression", C(e, S)]
                        }));
                        return [
                            ["require", "ec"]
                        ].concat(n).concat([
                            ["send", "event", R(e.origin), "Product Impressions", {
                                nonInteraction: !0
                            }]
                        ])
                    },
                    ClickProduct: function(e) {
                        ...
                        return [
                            ...
                            ["send", "event", R(e.origin), "Product Click", n]
                        ])
                    },
                    ViewContent: function(e) {
                        var n = e.name ? e.name : "(not set)";
                        return [
                            ...
                            ["ec:addImpression", C(e, S)]
                        ]).concat([
                            ["ec:setAction", "detail"]
                        ]).concat([
                            ["send", "event", R(e.origin), "View Content", n, {
                                nonInteraction: !0
                            }]
                        ])
                    },
                    AddToCart: function(e) {
                        ...
                        return [
                            ...
                            ["send", "event", R(e.origin), "Add to Cart", n]
                        ])
                    },
                    RemoveFromCart: function(e) {
                        ...
                        return [
                            ...
                            ["send", "event", R(e.origin), "Remove from Cart", n]
                        ])
                    },
                    InitiateCheckout: function(e) {
                        var n = (e.contents || []).map((function(e) {
                                return ["ec:addProduct", C(e, S)]
                            })),
                            t = C({
                                option: e.option
                            }, S);
                        return [
                            ...
                            ["send", "event", R(e.origin), "Initiate Checkout"]
                        ])
                    },
                    StartPayment: function(e) {
                        ...
                        return [
                            ...
                            ["send", "event", R(e.origin), "Start Payment"]
                        ])
                    },
                    AddPaymentInfo: function(e) {
                        var n = C({
                        ...
                        return [
                            ...
                            ["send", "event", R(e.origin), "Add Payment Info"]
                        ])
                    },
                    CheckoutStep: function(e) {
                        ...
                        return [
                            ...
                            ["send", "event", R(e.origin), "Checkout Step " + n.step]
                        ])
                    },
                    Purchase: function(e) {
                        var n = (e.contents || []).map((function(e) {
                        ...
                        return ["id", "affiliation", "revenue", "tax", "shipping", "coupon"].forEach((function(n) {
                            ...
                            ["ec:setAction", "purchase", C(t, S)]
                        ]).concat([
                            ["send", "event", R(e.origin), "Purchase"]
                        ])
                    },
                    Lead: function(e) {
                        var n = e.category,
            ...
            var te = Object.keys(ee).reduce((function(e, n) {
                    return e[n] = function(e, t) {
                        ...
                        return t.context && t.context.appDefId && (r.appId = t.context.appDefId), t.preventDefaultChannels ? [] : ("Purchase" === n && (r.features = X({
            ...
            var ie, ce, ae, ue, se = {
                ...
                Te = function(e, n) {
                    var t, r;
                    t = xe, r = e, Object.prototype.hasOwnProperty.call(t, r) || (xe[e] = n)
                },
                Oe = function(e, n) {
                    Object.keys(xe).forEach((function(t) {
                        xe[t].call(undefined, e, function(e) {
            ...
            var Se = {
                ...
                Re = ((ae = {})[Se.FACEBOOK_PIXEL] = O, ae[Se.GOOGLE_ANALYTICS] = D, ae[Se.GOOGLE_TAG_MANAGER] = K, ae[Se.WIX_ANALYTICS] = Q, ae[Se.BI_ANALYTICS] = te, ae[Se.GTAG] = se, ae[Se.GLOBAL_GTAG] = ke, ae[Se.VK_RETARGETING] = {
                    PageView: function() {
                        return [
                            []
                        ]
                    }
                }, ae[Se.YANDEX_METRICA] = we, ae),
                De = ((ue = {})[Se.WIX_DEVELOPERS_ANALYTICS] = function(e, n) {
                    if (e) {
                        if (window) {
                ...
                Ge = function() {
                    ...
                    return n.isChannelPredefined = function(e) {
                        ...
                        e.events = Re[e.name], e.events.publicTracking && e.events.publicTracking instanceof Function && e.events.publicTracking()
                        ...
                        this.isChannelValid(e) && (Re[e.name] = e.events)
                    }, e
                }(),
                Ve = new Ge,
                Ne = function(e) {
                    void 0 === e && (e = []), e.forEach(Ve.addChannel)
                },
                je = function(e, n) {
                    Ve.addListener(e, n)
                },
                ...
                qe = function(e, n, t) {
                    Ve.trackEventToChannelsOnly(e, n, t)
                },
                Me = function(e, n, t) {
                    Ve.trackEventToListenersOnly(e, n, t)
                }
        }(), r
    }()
}));
