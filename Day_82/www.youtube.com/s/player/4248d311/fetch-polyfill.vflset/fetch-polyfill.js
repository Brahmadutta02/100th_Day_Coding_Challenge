...
(function(self) {
    ...
    function Body() {
        ...
        this._initBody = function(body) {
            ...
            else if (support.searchParams && URLSearchParams.prototype.isPrototypeOf(body)) this._bodyText =
                body.toString();
    ...
    function Request(input, options) {
        ...
        this.referrer = null;
        if ((this.method ===
                "GET" || this.method === "HEAD") && body) throw new TypeError("Body not allowed for GET or HEAD requests");
        this._initBody(body)
    }
    ...
    self.fetch = function(input, init) {
        return new Promise(function(resolve, reject) {
            ...
            xhr.onload = function() {
                ...
                var body = "response" in
                    xhr ? xhr.response : xhr.responseText;
