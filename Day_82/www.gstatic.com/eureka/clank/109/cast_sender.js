(function() {
    ...
    */
    ...
    f.cc = function(a, b, c) {
        0 > Ka(this, a) || D.o(this, "QUEUE_REMOVE", new chrome.cast.media.va([a]), b, c, chrome.cast.media.timeout.v)
    };
    f.ec = function(a, b, c) {
    ...
    var Y = function(a, b, c) {
        ...
        wb = function(a) {
            var b = Z;
            ub.has(a.type) && b.ja && (b.m ? (a.sessionId = b.m, vb(b, null, a.type, a, function() {}, function() {})) : b.Va.A(X(b, void 0, "urn:x-cast:com.google.cast.media",
                a)))
        };
    ...
    V.prototype.requestSession = function(a, b, c) {
        var d = this;
        this.j ? sb(b) : (c = X(this, c), this.j = a, (new PresentationRequest(c)).start().then(function(e) {
            Y(d, e, b)
        }).catch(function(e) {
            d.j = null;
    ...
    var X = function(a, b, c, d) {
        ...
        var k = b.dialRequest;
        k && (e = k.appName, (g = k.launchParameter) && !g.match(xb) && (g = qb(g)));
        var l = [];
        l.push({
            appId: b.appId,
        ...
        return cb(new bb(l, a.A.h, a.g.autoJoinPolicy, a.g.defaultActionPolicy, b.requestSessionTimeout, e, g, a.g.invisibleSender, c, d, b.androidReceiverCompatible, b.credentialsData))
    };
    V.prototype.Fa = function(a, b, c, d) {
        var e = this;
        this.D++;
        vb(this, null, b, a, function(g) {
            e.D--;
            g.j = !0;
            c && c(g)
        }, function(g) {
    ...
    V.prototype.onMessage = function(a) {
        ...
        if (b = Ya(this.K, a.sequenceNumber)) "error" == a.type ? (b = b.g) && b(a.message) : (b = b.j) && b(a.message);
